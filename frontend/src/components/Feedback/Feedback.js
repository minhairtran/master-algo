...
export const FeedbackButton = (props) => {
  const [feedbackButtonDisplay, setFeedbackButtonDisplay] = useState(true);
  ...
  const feedbackButtonDisplayClass = feedbackButtonDisplay ? "" : "d-none";
  ...
  return (
    <div className={feedbackButtonDisplayClass}>
      <div
